...
> Vendored verbatim from https://skills.stellar.org/skills/assets/SKILL.md (official Stellar assets skill).
> Relevant to zkNemo only if the demo pool uses a SAC test token instead of native XLM (plan D5). See `../stellar-private-payments-poc/SKILL.md`.
> Relative links (`../soroban`, `../dapp`, `../data`, `../standards`) point at the upstream Stellar skill repo.
