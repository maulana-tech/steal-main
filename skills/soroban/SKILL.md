...
> Vendored verbatim from https://skills.stellar.org/skills/soroban/SKILL.md (official Stellar soroban skill).
> zkNemo reuses the Nethermind PoC contracts; only relevant if we fork the Pool/Verifier/ASP contracts (plan D1). See `../stellar-private-payments-poc/SKILL.md`.
> Relative links (`../assets`, `../dapp`, `../data`, `../zk-proofs`, `../standards`) point at the upstream Stellar skill repo.
