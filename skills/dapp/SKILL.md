...
> Vendored verbatim from https://skills.stellar.org/skills/dapp/SKILL.md (official Stellar dapp skill).
> zkNemo-specific application lives in `../stellar-frontend-integration/SKILL.md`.
> Relative links below (`../soroban`, `../assets`, `../data`, `../agentic-payments`, `../standards`) point at the upstream Stellar skill repo, not this repo.
