...
> Vendored verbatim from https://skills.stellar.org/skills/zk-proofs/SKILL.md (official Stellar zk-proofs skill).
> zkNemo-specific application of this guidance lives in `../stellar-zk-primitives/SKILL.md`.
> Relative links below (`../soroban`, `../assets`, `../dapp`, `../standards`) point at the upstream Stellar skill repo, not this repo.
