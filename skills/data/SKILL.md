...
> Vendored verbatim from https://skills.stellar.org/skills/data/SKILL.md (official Stellar data skill).
> zkNemo uses this for commitment scanning, contract-state reads, event polling, and tx confirmation (plan P2). See `../stellar-frontend-integration/SKILL.md`.
> Relative links (`../dapp`, `../soroban`, `../assets`, `../standards`) point at the upstream Stellar skill repo.
